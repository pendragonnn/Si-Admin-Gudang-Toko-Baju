<div class="container">
  <table class="table table-striped">
    ...
    <tr>
      <td><?=$count?></td>
        <?php
          $subqry="SELECT * from product p, product_size_variation v where p.product_id=v.product_id AND v.variation_id=$v_id";
      ...
      <td><?=$row2["product_name"] ?></td>
        <?php
          ...
          $subqry2="SELECT * from sizes s, product_size_variation v where s.size_id=v.size_id AND v.variation_id=$v_id";
